        ...
        <section class="slide" id="s-signup" data-sec="Get Started">
            <div class="inner">
                <div class="divider">
                    ...
                    <a class="cta reveal" data-delay="4" href="''' + SIGNUP + '''&utm_content=end-cta" target="_blank" rel="noopener" onclick="return openSignup(event,'end-cta')">Create your account <svg viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
                </div>
            </div>
        </section>
'''
