...
IMX_WORLD = '''        <!-- Infomedix world -->
        <section class="slide" id="s-imx1" data-sec="Infomedix">
            <div class="inner">
                <div class="slide-head">
                    <div class="label imx reveal"><svg viewBox="0 0 24 24"><path d="M3 21h18"/><path d="M5 21V7l8-4v18"/><path d="M19 21V11l-6-4"/></svg> Why Arvi &middot; Infomedix</div>
                    <h2 class="title reveal" data-delay="1">Built for the World Infomedix Already Owns</h2>
...
IMX_INTEG = '''        <!-- Integration -->
        <section class="slide" id="s-imx2" data-sec="Infomedix">
            <div class="inner">
                <div class="slide-head">
                    <div class="label imx reveal"><svg viewBox="0 0 24 24"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg> Integration</div>
                    <h2 class="title reveal" data-delay="1">How Arvi Plugs Into the Infomedix Suite</h2>
                    <p class="subtitle reveal" data-delay="2">Arvi is the AI capture &amp; authoring front end; Infomedix is the record, workflow and coding backbone. Structured output flows straight in over HL7 / FHIR, the interoperability layer Infomedix already runs.</p>
                </div>
                <div class="integ">
                    ...
                    <div class="imx-prods">
                        <div class="imx-prod glass reveal" data-delay="3"><h4>Digital Patient Chart</h4><p>Arvi notes file straight into the chart, complete, on time.</p></div>
                        <div class="imx-prod glass reveal" data-delay="4"><h4>Referrals Manager</h4><p>Auto-generated referral letters drop into the HL7 referral pipeline.</p></div>
                        <div class="imx-prod glass reveal" data-delay="4"><h4>Discharge Manager</h4><p>Discharge summaries authored from the recording, not retyped.</p></div>
                        <div class="imx-prod glass reveal" data-delay="5"><h4>Coding Manager</h4><p>Richer structured source notes lift coding accuracy &amp; speed.</p></div>
                        <div class="imx-prod glass span reveal" data-delay="5"><h4>Clinivid</h4><p>Arvi notes &amp; letters shared through Infomedix's clinician collaboration layer.</p></div>
                    </div>
                </div>
            </div>
        </section>
...
IMX_VALUE = '''        <!-- Value -->
        <section class="slide" id="s-imx3" data-sec="Infomedix">
            <div class="inner fill">
                <div class="slide-head">
                    <div class="label imx reveal"><svg viewBox="0 0 24 24"><line x1="12" y1="20" x2="12" y2="10"/><line x1="18" y1="20" x2="18" y2="4"/><line x1="6" y1="20" x2="6" y2="16"/></svg> The Value</div>
                    <h2 class="title reveal" data-delay="1">What Arvi Adds to Infomedix</h2>
                    <p class="subtitle reveal" data-delay="2">A complementary capability, not a competing one, Arvi makes the existing suite more valuable and stickier.</p>
                </div>
                <div class="cards c3">
                    <div class="card glass reveal" data-delay="2"><div class="vic"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg></div><h3>Fills the AI gap</h3><p>Adds ambient AI documentation, the one capability the suite doesn't have, in the hottest category in health IT.</p></div>
                    <div class="card glass reveal" data-delay="3"><div class="vic"><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg></div><h3>More, better documents</h3><p>Feeds the 2B-document chart with complete, structured, on-time notes created at the point of care.</p></div>
                    <div class="card glass reveal" data-delay="4"><div class="vic"><svg viewBox="0 0 24 24"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg></div><h3>Lifts coding outcomes</h3><p>Richer source documentation directly improves Coding Manager accuracy, speed and revenue capture.</p></div>
                    <div class="card glass reveal" data-delay="3"><div class="vic"><svg viewBox="0 0 24 24"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg></div><h3>Automates referrals &amp; discharge</h3><p>Letters and summaries are generated, not retyped, accelerating the workflows Infomedix sells.</p></div>
                    <div class="card glass reveal" data-delay="4"><div class="vic"><svg viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></div><h3>Deeper stickiness</h3><p>Capture, chart, code and send in one loop raises switching costs across the whole suite.</p></div>
                    <div class="card glass reveal" data-delay="5"><div class="vic"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg></div><h3>Ready distribution</h3><p>Infomedix's 250+ hospitals and 46k daily users are an instant channel for Arvi.</p></div>
                </div>
            </div>
        </section>
'''
...
CLOSE = '''        <!-- Close -->
        <section class="slide" id="s-close" data-sec="Infomedix">
            <div class="inner">
                <div class="close">
                    <img class="reveal" src="arvi logo.avif" alt="Arvi Health">
                    <h2 class="title reveal" data-delay="1">The Documentation Layer for Infomedix's Hospitals</h2>
                    <p class="subtitle reveal" data-delay="2">Arvi captures and authors at the point of care. Infomedix records, routes and codes. Together: complete clinical documentation, end to end, live today, on web and mobile.</p>
