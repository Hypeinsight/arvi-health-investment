                ...
                <div class="rm-wrap">
                    <div class="rm">
                        <div class="rmcard lite reveal" data-delay="3">
                            ...
                            <ul><li>Inbound pathology &amp; results ingestion</li><li>HealthLink &amp; patient-management system integrations</li><li>Real-time transcription &amp; live note preview</li><li>ISO 27001 / SOC 2 certification</li></ul>
                        </div>
                        <div class="rmcard lite reveal" data-delay="4">
