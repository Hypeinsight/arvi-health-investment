...
CSS = r"""
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .econ-dial{display:flex;gap:clamp(1rem,2.6vw,2.2rem);align-items:center;flex-wrap:wrap;padding:clamp(1rem,1.7vw,1.5rem);margin-top:clamp(.9rem,2vh,1.4rem)}
        .econ-dial .dial-outs{display:grid;grid-template-columns:1fr 1fr;gap:clamp(.7rem,1.6vw,1.2rem)}
        .econ-dial .do{text-align:center}
        .econ-dial .do-v{font-size:clamp(1.5rem,2.8vw,2.3rem);font-weight:800;line-height:1;background:linear-gradient(118deg,var(--primary),var(--accent));-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent}
        .econ-dial .do-l{font-size:.72rem;color:var(--muted);margin-top:.35rem;line-height:1.3}
        /* --- ask --- */
        ...
        .dlcard .ds{font-size:.76rem;color:var(--muted)}
...
FEATURES = [
 ...
 ("Core Documentation","Quick Record for Emergencies",
  ...
  "newui-quick-record.mp4","Arvi &middot; Quick Record"),
 ...
 ("Letters &amp; Templates","Approve, Send &amp; Resend",
  ...
  "newui-send.mp4","platform.arvihealth.com &middot; Send"),
 ...
 ("Letters &amp; Templates","Patient Summaries",
  ...
  "newui-patient-summary.mp4","platform.arvihealth.com &middot; Patient summary"),
 ...
 ("Patient &amp; Workflow","Import Your Patients",
  ...
  "newui-add-patients.mp4","platform.arvihealth.com &middot; Patients"),
            ...
            <div class="inner">
                <div class="intro">
                    <div class="feature-copy">
                        ...
                        <div class="tags reveal" data-delay="3"><span class="tag">Web &amp; mobile apps</span><span class="tag">22 production features</span><span class="tag">HealthLink / HL7 v2.3.1</span></div>
                    </div>
                    <figure class="clip reveal" data-delay="2">
                        <div class="clip-glow"></div>
        ...
        <section class="slide" id="s-platform" data-sec="Overview">
            <div class="inner fill">
                <div class="slide-head">
                    ...
                    <h2 class="title reveal" data-delay="1">One Platform. Two Apps. Twenty-Two Production Features.</h2>
            ...
            <div class="inner">
                ...
                <div class="integ">
                    ...
                    <div class="pipe reveal" data-delay="3">
                        <div class="pl">HealthLink, HL7 v2.3.1<br>FHIR via HaloConnect next</div>
        ...
        <section class="slide" id="s-close" data-sec="InfoMedix">
            <div class="inner">
                <div class="close">
                    ...
                    <div class="tags reveal" data-delay="3" style="justify-content:center"><span class="tag">20 features in production</span><span class="tag">HealthLink / HL7 v2.3.1</span><span class="tag">Built for acute care</span></div>
        ...
        <section class="slide" id="s-ask" data-sec="The Raise">
            <div class="inner">
                ...
                <div class="cards c2" style="max-width:920px;margin:clamp(1rem,2.4vh,1.6rem) auto 0">
                    ...
                    <div class="card glass reveal" data-delay="5"><h3>Enterprise ready</h3><p>HealthLink delivery live; FHIR via HaloConnect and enterprise integrations delivered.</p></div>
                ...
                <div class="rm-wrap">
                    ...
                    <div class="rm">
                        ...
                        <div class="rmcard lite reveal" data-delay="4">
                            ...
                            <ul><li>National rollout across capital cities</li><li>HealthLink delivery &amp; FHIR via HaloConnect</li><li>Specialist vertical expansion</li></ul>
        ...
        <section class="slide" id="s-imx2b" data-sec="InfoMedix">
            <div class="inner">
                <div class="slide-head">
                    ...
                    <p class="subtitle reveal" data-delay="2">Today Arvi delivers consultation notes through HealthLink over HL7 v2.3.1. Next, a FHIR integration via our partner HaloConnect drops notes straight into Best Practice and other clinical software. Where that lines up with your roadmap, there is a natural fit, and we would shape it together.</p>
                </div>
                <div class="integ">
                    <div class="integ-arvi reveal" data-delay="2">
                        <div class="il">Capture &amp; authoring</div>
        ...
        <section class="slide" id="s-proadmap" data-sec="Roadmap">
            <div class="inner fill">
                <div class="slide-head">
                    ...
                    <p class="subtitle reveal" data-delay="2">Beyond today's twenty-two production features, the capabilities on Arvi's near and long-term horizon.</p>
                </div>
                <div class="rm-wrap">
                    <div class="rm">
                        <div class="rmcard lite reveal" data-delay="3">
                            ...
                            <ul><li>HealthLink note delivery, HL7 v2.3.1 (live)</li><li>FHIR via HaloConnect into Best Practice &amp; clinical software</li><li>Inbound pathology &amp; results ingestion</li><li>Real-time transcription &amp; live note preview</li><li>ISO 27001 / SOC 2 certification</li></ul>
                        </div>
                        <div class="rmcard lite reveal" data-delay="4">
                            ...
                            <ul><li>Hospital EMR integration</li><li>Coding-ready structured output (SNOMED / ICD-aligned)</li><li>Evidence: guideline-backed answers at the point of care</li><li>Specialty-tuned models across disciplines</li><li>Organisation analytics &amp; insights</li></ul>
                        </div>
                        <div class="rmcard climax reveal" data-delay="5">
        ...
        <section class="slide" id="s-vision" data-sec="Vision">
            <div class="inner">
                <div class="divider">
                    ...
                    <p class="vision-statement reveal" data-delay="1">To become the autonomous operating system for healthcare: giving every clinician their time back, and letting every clinic run on its own intelligence.</p>
                </div>
            </div>
        </section>
'''
        ...
        <section class="slide" id="s-appendix" data-sec="Appendix">
            <div class="inner">
                <div class="divider">
                    ...
                    <p class="subtitle reveal" data-delay="2" style="text-align:center;max-width:720px;margin:0 auto">Recorded demos of all twenty-two features, across the five areas, for reference. Jump to any feature on request.</p>
                    <div class="menu reveal" data-delay="3">
                        <span class="mi"><b>01</b> Core Documentation</span>
                        <span class="mi"><b>02</b> Letters &amp; Templates</span>
                        <span class="mi"><b>03</b> Patient &amp; Workflow</span>
        ...
        <section class="slide" id="s-unit" data-sec="The Raise">
            <div class="inner">
                ...
                <div class="econ">
                    ...
                    <div class="econ-step glass reveal" data-delay="4"><div class="ev">+ $12</div><div class="el">margin per $29 pack</div><div class="ed">Each 10-hour top-up is $29 with about $12 margin; active clinicians buy at least one.</div></div>
                </div>
                <div class="econ-foot">
                    <div class="ef glass reveal" data-delay="5"><span class="efv">$24 / user / mo</span> a typical active clinician runs ~15 hrs/month: the base plus one 10-hour pack. <b>Double the base margin.</b></div>
                    <div class="ef glass reveal" data-delay="5"><span class="efv">$36+ / user / mo</span> a heavy user adds a second pack, and keeps going. Every 10-hour pack ($29) is another <b>~$12 of margin.</b></div>
                </div>
                <div class="econ-dial glass reveal" data-delay="6">
                    <div class="calc-field" style="flex:1;min-width:250px"><label>Active users <span id="sc-doc-v">2,500</span></label><input type="range" id="sc-doc" min="500" max="10000" step="100" value="2500"><p class="calc-note" style="margin-top:.45rem">Revenue scales with adoption: the typical active clinician runs $30 base + one 10-hour pack ($29). Priced for adoption anywhere in the world.</p></div>
                    <div class="dial-outs" style="flex:0 0 auto;min-width:280px">
                        <div class="do"><div class="do-v" id="sc-mo">0</div><div class="do-l">revenue / month</div></div>
                        <div class="do"><div class="do-v" id="sc-yr">0</div><div class="do-l">revenue / year</div></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="slide" id="s-solution" data-sec="The Solution">
            <div class="inner fill">
                ...
                <div class="cards c4">
                    ...
                    <div class="card glass reveal" data-delay="4" style="display:flex;flex-direction:column"><div class="vic"><svg viewBox="0 0 24 24"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg></div><h3>Interoperability</h3><p>Notes delivered today through HealthLink (HL7 v2.3.1). FHIR via partner HaloConnect next, dropping straight into Best Practice and other clinical software.</p><span class="sol-pill"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg>Hospital ready</span></div>
                ...
                <div class="workflow reveal" data-delay="5">
                    <b>1. Consult</b><svg viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg><b>2. Transcribe</b><svg viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg><b>3. Structure</b><svg viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg><b>4. Deliver (HealthLink / Bp)</b>
                </div>
            </div>
        </section>
'''

USEOFFUNDS = '''        <!-- Use of funds / rollout -->
        <section class="slide" id="s-funds" data-sec="The Raise">
            <div class="inner fill">
                <div class="slide-head">
                    <div class="label reveal"><svg viewBox="0 0 24 24"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> Use of Funds</div>
                    <h2 class="title reveal" data-delay="1">Deploying the Round</h2>
                    <p class="subtitle reveal" data-delay="2">$2M put to work over 12 to 14 months, controlled and aggressive, built to hit the targets fast.</p>
                </div>
                <div class="cards c4">
                    <div class="card glass reveal" data-delay="2" style="display:flex;flex-direction:column"><div style="display:flex;align-items:baseline;gap:.5rem"><span style="font-size:clamp(1.6rem,2.6vw,2.2rem);font-weight:800;line-height:1;background:linear-gradient(118deg,var(--primary),var(--accent));-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent">50%</span><span style="font-size:.8rem;color:var(--muted);font-weight:700">$1.0M</span></div><h3>Sales &amp; market penetration</h3><p>2+ sales hires, hospital pilots, CPD webinars, roundtables and account-based outreach.</p></div>
                    <div class="card glass reveal" data-delay="3" style="display:flex;flex-direction:column"><div style="display:flex;align-items:baseline;gap:.5rem"><span style="font-size:clamp(1.6rem,2.6vw,2.2rem);font-weight:800;line-height:1;background:linear-gradient(118deg,var(--primary),var(--accent));-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent">25%</span><span style="font-size:.8rem;color:var(--muted);font-weight:700">$0.5M</span></div><h3>Product &amp; engineering</h3><p>FHIR via HaloConnect, EMR integrations, ISO / SOC 2 certification, the agentic roadmap and mobile.</p></div>
                    <div class="card glass reveal" data-delay="4" style="display:flex;flex-direction:column"><div style="display:flex;align-items:baseline;gap:.5rem"><span style="font-size:clamp(1.6rem,2.6vw,2.2rem);font-weight:800;line-height:1;background:linear-gradient(118deg,var(--primary),var(--accent));-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent">20%</span><span style="font-size:.8rem;color:var(--muted);font-weight:700">$0.4M</span></div><h3>Operations</h3><p>Office, support, tooling and infrastructure as usage scales.</p></div>
                    <div class="card glass reveal" data-delay="5" style="display:flex;flex-direction:column"><div style="display:flex;align-items:baseline;gap:.5rem"><span style="font-size:clamp(1.6rem,2.6vw,2.2rem);font-weight:800;line-height:1;background:linear-gradient(118deg,var(--primary),var(--accent));-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent">5%</span><span style="font-size:.8rem;color:var(--muted);font-weight:700">$0.1M</span></div><h3>Working capital</h3><p>Buffer and contingency to move quickly.</p></div>
                </div>
                <div class="gtm-chips reveal" data-delay="6" style="margin-top:clamp(1rem,2.4vh,1.6rem)">
                    <span class="gtm-chip"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg>Months 1-6: 100 practices</span>
                    <span class="gtm-chip"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg>Months 7-12: 500 practices</span>
                    <span class="gtm-chip"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg>~14 months: Series A-ready</span>
                </div>
            </div>
        </section>
'''

BODY = (INTRO + TEAM + AGENDA + PROBLEM + VISION + WALK + PRODUCT_ROADMAP
        + PLATFORM + SOLUTION + TRACTION + CALCULATOR + COMPETITIVE + MARKET
        + IMX_INTEG_ALT + ROADMAP + UNITECON + FINANCIALS + ASK + USEOFFUNDS + CLOSE
        + APPENDIX + FEAT)
...
SCRIPT = r"""
        (function(){
            ...
            // Scale dial: active users -> revenue at ~$59 / user / month (base + one pack)
            (function(){
