        ...
        <section class="slide" id="s-vision" data-sec="Vision">
            <div class="inner">
                <div class="divider">
                    ...
                    <div class="big reveal" data-delay="1">Beyond the Scribe: the AI That Runs the Clinic</div>
                    <p class="subtitle reveal" data-delay="2" style="text-align:center;max-width:820px;margin:0 auto">Arvi listens across the whole practice, remembers every conversation, referral and result, and acts on it: booking follow-ups, drafting referrals, ordering tests, coordinating care. The clinician approves; Arvi does the admin. Not a documentation tool, an autonomous healthcare operating system.</p>
                    <div class="menu reveal" data-delay="3">
                        <span class="mi">Listen</span>
                        <span class="mi">Reason</span>
