        ...
        <section class="slide" id="s-traction" data-sec="Traction">
            <div class="inner">
                ...
                <div class="cards" style="grid-template-columns:0.92fr 1.08fr;gap:clamp(1.2rem,3vw,2.2rem);align-items:stretch">
                    ...
                    <figure class="clip reveal" data-delay="3" style="align-self:center;min-width:0">
                        <div class="clip-frame"><div class="chrome"><i></i><i></i><i></i><span class="url">app.arvihealth.com &middot; Letter statistics</span></div><img src="screenshot.png" alt="Arvi letter statistics dashboard at Sydney Gut Clinic"></div>
                        <figcaption><b>Live usage at Sydney Gut Clinic:</b> 4,611 letters generated &middot; 3,413 approved (74%) &middot; 1,638 sent</figcaption>
                    </figure>
                </div>
            </div>
        </section>
