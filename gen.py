        ...
        <section class="slide" id="s-vision" data-sec="Vision">
            <div class="inner">
                <div class="divider">
                    ...
                    <div class="big reveal" data-delay="1">Free Every Clinician.<br>Run Every Clinic.</div>
                    <p class="subtitle reveal" data-delay="2" style="text-align:center;max-width:720px;margin:0 auto">An autonomous operating system for healthcare, where every clinical conversation becomes action.</p>
                    <div class="menu reveal" data-delay="3">
